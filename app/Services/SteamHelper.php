...
class SteamHelper
{
    ...
    public static function getPlayersComparison($userStats1, $userStats2)
    {
        ...
        $userStatsOne[0] = $userArray['total_kills'] ?? '0';
        $userStatsOne[1] = $userArray['total_deaths'] ?? '0';
        $userStatsOne[2] = round($userArray['total_time_played']/3600) ?? '0';
        $userStatsOne[3] = $userArray['total_wins'] ?? '0';
        $userStatsOne[4] = $userArray['total_damage_done'] ?? '0';
        $userStatsOne[5] = $userArray['total_money_earned'] ?? '0';
        $userStatsOne[6] = $userArray['total_mvps'] ?? '0';
        $userStatsOne[7] = $userArray['total_contribution_score'] ?? '0';
        $userStatsOne[8] = $userArray['total_weapons_donated'] ?? '0';
        $userStatsOne[9] = $userArray['total_kills_headshot'] ?? '0';
        $userStatsOne[10] = $userArray['total_wins_pistolround'] ?? '0';
        $userStatsOne[11] = $userArray['total_kills_hegrenade'] ?? '0';
        $userStatsOne[12] = $userArray['total_kills_deagle'] ?? '0';
        $userStatsOne[13] = $userArray['total_kills_awp'] ?? '0';
        $userStatsOne[14] = $userArray['total_kills_molotov'] ?? '0';
        $userStatsOne[15] = $userArray['total_kills_m4a1'] ?? '0';
        $userStatsOne[16] = $userArray['total_kills_ak47'] ?? '0';
        $userStatsOne[17] = $userArray['total_kills_knife'] ?? '0';
        $userStatsOne[18] = $userArray['total_kills_taser'] ?? '0';
        $userStatsOne[19] = $userArray['total_broken_windows'] ?? '0';
        $userStatsOne[20] = round($userArray['total_gun_game_rounds_won']/$userArray['total_gun_game_rounds_played'],2) ?? '0';

        $userStatsTwo[0] = $userArray2['total_kills'];
        $userStatsTwo[1] = $userArray2['total_deaths'] ?? '0';
        $userStatsTwo[2] = round($userArray2['total_time_played']/3600)  ?? '0';
        $userStatsTwo[3] = $userArray2['total_wins'] ?? '0';
        $userStatsTwo[4] = $userArray2['total_damage_done'] ?? '0';
        $userStatsTwo[5] = $userArray2['total_money_earned'] ?? '0';
        $userStatsTwo[6] = $userArray2['total_mvps'] ?? '0';
        $userStatsTwo[7] = $userArray2['total_contribution_score'] ?? '0';
        $userStatsTwo[8] = $userArray2['total_weapons_donated'] ?? '0';
        $userStatsTwo[9] = $userArray2['total_kills_headshot'] ?? '0';
        $userStatsTwo[10] = $userArray2['total_wins_pistolround'] ?? '0';
        $userStatsTwo[11] = $userArray2['total_kills_hegrenade'] ?? '0';
        $userStatsTwo[12] = $userArray2['total_kills_deagle'] ?? '0';
        $userStatsTwo[13] = $userArray2['total_kills_awp'] ?? '0';
        $userStatsTwo[14] = $userArray2['total_kills_molotov'] ?? '0';
        $userStatsTwo[15] = $userArray2['total_kills_m4a1'] ?? '0';
        $userStatsTwo[16] = $userArray2['total_kills_ak47'] ?? '0';
        $userStatsTwo[17] = $userArray2['total_kills_knife'] ?? '0';
        $userStatsTwo[18] = $userArray2['total_kills_taser'] ?? '0';
        $userStatsTwo[19] = $userArray2['total_broken_windows'] ?? '0';
        $userStatsTwo[20] = round($userArray2['total_gun_game_rounds_won']/$userArray2['total_gun_game_rounds_played'],2) ?? '0';
